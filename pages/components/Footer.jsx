      ...
      <div className="container">
          ...
          <div className="row">
              ...
              <div className="footer-widget widget-about">
                <div className="widget-content">
                  <div className="footer-logo-wrap">
                    <a href="index.html" className="logo-img theme-light-logo">
                      <img
                        src="/assets/images/anasbehhari-logo.svg"
                        alt="Arun Roy"
                      />
                    </a>
                    <a href="index.html" className="logo-img theme-dark-logo">
                      <img
                        src="/assets/images/anasbehhari-logo.svg"
                        alt="Arun Roy"
                      />
            ...
            <div className="col-lg-7">
              <div className="widget secondary-nav flex">
                ...
                <div className="nav-col">
                  <h3 className="title h6">See more</h3>
                  <nav>
                    <ul className="no-style-list">
                      <li className="nav-link">
                        <Link
        ...
        <div className="footer-bottom flex justify-space-between">
          ...
          <div className="copyright">
            © 2021 <a href="index.html">Anas Behhari</a> - All right Reserved
          </div>
        </div>
      </div>
    </footer>
