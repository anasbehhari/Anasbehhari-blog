  ...
  if (blog) {
    ...
    return (
      <>
        <Head>
          <title>
            {StaticFunction.replaceAll(title, "-", " ")} | Anas Behhari's Blogs
            2021
          </title>
        </Head>
        <div className="main">
              ...
              <div className="col-lg-10 offset-lg-1">
                <article className="art-1">
                  <header className="post-header">
                    ...
                    <div
                      className="post-meta flex"
                      style={{ alignItems: "center" }}
                    >
                      <div
                        className="author-list flex"
                        style={{ alignItems: "center" }}
                      >
                        <a
                          target="_blank"
                          rel="noreferrer"
                          href="https://linkedin.com/in/anasbehhari"
                        >
                          <img
                        ...
                        <div className="seen">
                          ...
                          >
                            <g>
                              ...
                              <path
                                style={{ fill: "currentcolor" }}
                                d="M8,2.981c-5.003,0-8,5.009-8,5.009s2.985,5.029,8,5.029s8-5.029,8-5.029S13.003,2.981,8,2.981z M8,10.99c-1.657,0-3-1.343-3-3s1.343-3,3-3s3,1.343,3,3S9.657,10.99,8,10.99z"
                              />
                            </g>
                          </svg>
                      ...
                      >
                        ...
                        <a
                          ...
                          href={
                            ...
                            "&url=/blog/Self-observation-is-the-first-step-of-inner-unfolding"
                          }
                    ...
                    <div className="about-author flex">
                      ...
                      <div className="author-info">
                        <h3 className="name h5">
                          <a href="/portfolio">BEHHARI Anas</a>
                        </h3>
                        <div className="bio">
                          An Front-End web developer From Morocco 🇲🇦 and I love
                          billards 🎱 & snooker . On this site I write about my
...
export async function getStaticProps({ params }) {
  const res = await fetch(`http://localhost:3000/api/blogs/${params.title}?password=${process.env.password}`);
